...
string path = "C:\\Users\\AMD\\Desktop\\FacilitadorDeCompraApp\\lista_de_produto_para_comprar-2.csv";
...
{
    StreamWriter streamWriter = new StreamWriter($"C:\\Users\\AMD\\Desktop\\FacilitadorDeCompraApp\\ListaDeCompras{Regex.Replace(mercadoModel1.Nome, "[^A-Za-z0-9]", "_")}.txt");
